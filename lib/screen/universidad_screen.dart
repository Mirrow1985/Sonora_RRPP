...
class SeleccionUniversidadScreen extends StatelessWidget {
  const SeleccionUniversidadScreen({super.key});
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => RegistroScreen(universidad: 'Facultad de Ciencias', promocion: '2023'),
                  ),
                );
              },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => RegistroScreen(universidad: 'Ingeniería de Caminos', promocion: '2023'),
                  ),
                );
              },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => RegistroScreen(universidad: 'Ingeniería de la Edificación', promocion: '2023'),
                  ),
                );
              },
