// Mensaje de firebase cuando pones mal el mail, o te dice que el email ya esta siendo utilizado.
//No screenshot, probar con el emulador de vscode, en android me deja hacerlos
///
/
//
